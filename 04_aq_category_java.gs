...
'set strsiz 0.13'
'set string 1 r 2 0'
'draw string 10.5 7.75 'day' 'month' 'year' | ' time':00 WIB'
'set strsiz 0.18'
'set string 1 l 4 0'
'draw string 0.5 7.75 KUALITAS UDARA BERDASARKAN PM`b2.5'
'set strsiz 0.11'
'set string 1 l 2 90'
'draw string 10.6 0.95 BMKG-CAMS/ECMWF'
** highlight areas of interest
'set gxout shp'
'set line 25 1 1'
'set shpopts 24'
'draw shp /home/alberthnahas/Documents/basemap/World/world_without_idn.shp'
'set line 1 1 1'
'set shpopts -1'
'draw shp /home/alberthnahas/Documents/basemap/38_Provinsi/Indonesia_38_Provinsi.shp'
'set t 1'
'q time'
